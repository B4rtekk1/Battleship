            ...
            if (winner == null)
            {
                if (lastHited2 == -1 || direction1 == 1 || direction1 == 2)
                {
                    if (lastHited1 != -1)
                    {
                        ...
                        if (lastHited1 != -1 && !available)
                        {
                            if (lastHited1 - lastHited2 == -1)
                            {
                                lastHited1 = lastHited1 + 2;
                                newIndex = lastHited1 + 1;
                            ...
                            if (lastHited1 - lastHited2 == 1 && !available)
                            {
                                lastHited1 = lastHited1 - 2;
                                newIndex = lastHited1 - 1;
                ...
                if (lastHited2 == -1 || direction1 == 10 || direction1 == 20)
                {
                    if (!available && lastHited1 != -1)
                    {
                        ...
                        if (lastHited1 != -1 && !available)
                        {
                            if (lastHited1 - lastHited2 == -10)
                            {
                                lastHited1 = lastHited1 + 20;
                                newIndex = lastHited1 + 10;
                            ...
                            if (lastHited1 - lastHited2 == 10 && !available)
                            {
                                lastHited1 = lastHited1 - 20;
                                newIndex = lastHited1 - 10;
